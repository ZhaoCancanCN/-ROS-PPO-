...
from model.utils import test_init_pose, test_goal_point   #这个是产生初始点和目标点的关键
...
class StageWorld():
    ...
    def generate_goal_point(self): #这个是产生目标点的关键所在
    ...
    def reset_pose(self):   #这里是初始化机器人的位姿————————————————————————————————
